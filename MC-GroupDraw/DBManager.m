...
- (instancetype)initWithDatabaseFilename:(NSString *)dbFilename{
  ...
  if (self) {
    ...
    //Copy the database file into the documents directory if necessory
    [self copyDatabseIntoDocumentsDirectory];
    NSLog(@"DB Found");
...
- (void)copyDatabseIntoDocumentsDirectory
{
  ...
  if (![[NSFileManager defaultManager] fileExistsAtPath:destinationPath])
  {
    ...
    //Check if any error occureed during copying and display it.
    if (error != nil) {
